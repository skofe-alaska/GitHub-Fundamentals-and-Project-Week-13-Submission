...
- In 1-2 sentences, explain what kind of data each beat collects, and provide 1 example of what you expect to see. E.g., `Winlogbeat` collects Windows logs, which we use to track user logon events, etc._
  ...
  -  Metricbeat shows information for the process running on your system which including memory, CPU usage, file system, Network IO and disk IO statics. To view the data collected, To see the data, connect to Kibana, select the sytem to review and review the metrics of the system.
